            ...
            <div class='col-md-12'>
                <div class="header" style="display: flex;justify-content: space-between;align-items: center;">
                    ...
                    <div style="position: relative;top: 12px;">
                        <sup style="font-size: 10px;right: 50px">निधि</sup>
                        <sup style="font-size: 10px;left: 150px">जबलपुर न्यायालय के अंतर्गत</sup>
                        <h1>नरवरिया आभूषण</h1>
                        <small>शॉप नं. 2. शंभूश्री अपार्टमेंट, विवेकानंद वार्ड, एम. आर. विजय नगर, जबलपुर (म.प्र.) 482002</small>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-7">
                        <div class="bill-info">
                            <!-- <div><strong>Name:</strong> NIDHI NARVARIYA ABHUSHAN</div>
                            ...
                            <div><strong>GSTIN:</strong> 23CGSPN6374G12X</div>
                            <div><strong>REG. NO.:</strong> JABA2310245E016034</div>
                        </div>
                    </div>
                    <div class="col-sm-5">
                        <div class="bill-info">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>₹<?= $cgst_amt ?></td>
                                    <td>₹<?= $sgst_amt ?></td>
                                    <td>₹<?php $totalProductPrice += (($weight * $rate) + $cgst_amt + $sgst_amt);
                ...
                <div class="row bank-address" style="margin-top: 20px;">
                    <div class="col-md-6">
                        <div style="margin: 10px; border: 1px solid black;padding: 5px;">
                            ...
                            <p class="m-0">Nidhi: NARVARIA ABHUSHAN</p>
                            <p class="m-0">A/C: 502000088307803 | IFSC Code : HDFC0001282 </p>
                        ...
                        <div style="margin-top: 10px;">
                            <ol style="gap: 7px; display: grid;list-style: auto;">
                                ...
                                <li>जेवर से संबंधित लेन-देन करते समय पर्ची की मूलप्रति लाना आवश्यक है। 5. आभूषण का लेन-देन हमारे प्रतिष्ठान के नियमानुसार किया जावेगा।</li>
                ...
                <div class="row mt-2 p-2">
                    ...
                    <table id="footer_table" class="table table-bordered">
                        <tr>
                            <th>Customer Name: <?= $name ?></th>
                            <th>For Nidhi Narvaria Abhushan</th>
                        </tr>
                        <tr>
                    ...
                    <div class="d-flex justify-content-center">
                        <img src="../footer_logos.jpeg" style="width: 80%;" alt="">
                    </div>
                </div>
            </div>
        </div>
